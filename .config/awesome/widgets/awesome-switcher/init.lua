...
_M.settings = {
	...
	preview_box_title_font = {"Fira Code","Bold","normal"},
...
function _M.preview()
	...
	local bigFont = textboxHeight / 1.4
...
function _M.switch(dir, mod_key1, release_key, mod_key2, key_switch)
	...
	elseif #_M.altTabTable == 1 then
		...
		local tag = _M.altTabTable[1].client.first_tag
