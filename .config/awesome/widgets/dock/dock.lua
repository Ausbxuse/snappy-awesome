...
local class_icons = {
    -- Terminals
    ['kitty'] = { symbol = "", color = beautiful.fg_normal },
    ['Alacritty'] = { symbol = "", color = beautiful.fg_normal },
    ['Termite'] = { symbol = "", color = beautiful.fg_normal },
    ['URxvt'] = { symbol = "", color = beautiful.fg_normal },
    ['st'] = { symbol = "", color = beautiful.fg_normal },
    ['st-256color'] = { symbol = "", color = beautiful.fg_normal },

    -- Image viewers
    ['feh'] = { symbol = "", color = beautiful.fg_normal },
    ['Sxiv'] = { symbol = "", color = beautiful.fg_normal },

    -- General
    ['TelegramDesktop'] = { symbol = "", color = beautiful.fg_normal },
    ['Firefox'] = { symbol = "", color = beautiful.fg_normal },
    ['firefox'] = { symbol = "", color = beautiful.fg_normal },
    ['Brave-browser'] = { symbol = "", color = beautiful.fg_normal },
    ['Nightly'] = { symbol = "", color = beautiful.fg_normal },
    ['Chromium'] = { symbol = "", color = beautiful.fg_normal },
    ['Chromium-browser'] = { symbol = "", color = beautiful.fg_normal },
    ['Steam'] = { symbol = "", color = beautiful.fg_normal },
    ['Lutris'] = { symbol = "", color = beautiful.fg_normal },
    ['editor'] = { symbol = "", color = beautiful.fg_normal },
    ['Emacs'] = { symbol = "", color = beautiful.fg_normal },
    ['email'] = { symbol = "", color = beautiful.fg_normal },
    ['music'] = { symbol = "", color = beautiful.fg_normal },
    ['mpv'] = { symbol = "", color = beautiful.fg_normal },
    ['KeePassXC'] = { symbol = "", color = beautiful.fg_normal },
    ['Gucharmap'] = { symbol = "", color = beautiful.fg_normal },
    ['Pavucontrol'] = { symbol = "", color = beautiful.fg_normal },
    ['htop'] = { symbol = "", color = beautiful.fg_normal },
    ['Screenruler'] = { symbol = "", color = beautiful.fg_normal },
    ['Galculator'] = { symbol = "", color = beautiful.fg_normal },
    ['Zathura'] = { symbol = "", color = beautiful.fg_normal },
    ['Qemu-system-x86_64'] = { symbol = "", color = beautiful.fg_normal },
    ['Wine'] = { symbol = "", color = beautiful.fg_normal },
    ['markdown_input'] = { symbol = "", color = beautiful.fg_normal },
    ['scratchpad'] = { symbol = "", color = beautiful.fg_normal },
    ['weechat'] = { symbol = "", color = beautiful.fg_normal },
    ['discord'] = { symbol = "", color = beautiful.fg_normal },
    ['6cord'] = { symbol = "", color = beautiful.fg_normal },
    ['libreoffice-writer'] = { symbol = "", color = beautiful.fg_normal },
    ['libreoffice-calc'] = { symbol = "", color = beautiful.fg_normal },
    ['libreoffice-impress'] = { symbol = "", color = beautiful.fg_normal },
    ['Godot'] = { symbol = "", color = beautiful.fg_normal },

    -- File managers
    ['Thunar'] = { symbol = "", color = beautiful.fg_normal },
    ['Nemo'] = { symbol = "", color = beautiful.fg_normal },
    ['files'] = { symbol = "", color = beautiful.fg_normal },

    ['Gimp'] = { symbol = "", color = beautiful.fg_normal },
    ['Inkscape'] = { symbol = "", color = beautiful.fg_normal },
    ['Gpick'] = { symbol = "", color = beautiful.fg_normal },

    -- Default
    ['_'] = { symbol = "", color = beautiful.fg_normal.."99" }
}

-- TODO: These variables (and more) should ideally be retrieved through `beautiful`
local item_font = "icomoon 15"
local item_bg = beautiful.bg_default
