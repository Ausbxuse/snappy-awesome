...
pass_textbox:connect_signal("widget::redraw_needed", function()
    ...
    if #pass_textbox.text > 1 then
        ...
        secret_textbox.markup = "<span foreground='" .. beautiful.fg_normal ..
...
local create_button = function(hover_color, text, command)
    ...
    button:connect_signal("mouse::leave", function()
        ...
        button.border_color = beautiful.border_color_normal
    end)
...
local restart = create_button(beautiful.orange, "Restart", reboot_command)

local poweroff_command =
    function() awful.spawn.with_shell("systemctl poweroff") end
local shut = create_button(beautiful.orange, "Shutdown", poweroff_command)
