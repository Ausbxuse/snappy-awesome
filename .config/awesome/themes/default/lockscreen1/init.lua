...
package.cpath = package.cpath .. ";" .. config_dir .. "themes/default/lockscreen/library/?.so;"
...
local filesystem = require('gears.filesystem')
local config_dir = filesystem.get_configuration_dir()
local widget_icon_dir = config_dir .. 'themes/default/lockscreen/'
...
local wall_dir = gears.filesystem.get_configuration_dir() .. 'themes/default/lockscreen/wallpapers/'
