...
local widget_icon_dir = config_dir .. 'icons/battery/'
	...
	local update_battery = function(status)
		...
		awful.spawn.easy_async_with_shell(
			...
			function(stdout)
				...
				battery_widget.spacing = dpi(5/1.645)
				...
				elseif battery_percentage >= 90 and battery_percentage < 100 and status ~= 'fully-charged' then
