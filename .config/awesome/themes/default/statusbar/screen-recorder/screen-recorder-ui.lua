...
record_tbl.screen_rec_toggle_button = wibox.widget {
    {
      ...
      bg = {type = "linear", from = {0,0}, to = {0, 28}, stops = {{0, "#1daed4"},{0.5, "#6f86c9"},{1, "#e379d8"}}},
      --bg = "ffffff22",
...
record_tbl.screen_rec_toggle_button.visible = false
		...
		{
			{
				...
				margins = dpi(24/1.645),
				widget = wibox.container.margin
			},
			widget = clickable_container
		},
		forced_width = dpi(200/1.645),
		forced_height = dpi(200/1.645),
...
record_tbl.screen_rec_audio_button = wibox.widget {
	...
	forced_width = dpi(60/1.645),
	forced_height = dpi(60/1.645),
	bg = beautiful.groups_bg,
	shape =  gears.shape.circle,
	widget = wibox.container.background
}
...
record_tbl.screen_rec_back_button = wibox.widget {
	...
	forced_width = dpi(48/1.645),
	forced_height = dpi(48/1.645),
	bg = beautiful.groups_bg,
