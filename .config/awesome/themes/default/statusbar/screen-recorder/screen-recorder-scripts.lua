...
local user_config = require('themes.default.statusbar.screen-recorder.screen-recorder-config')
local scripts_tbl = {}
...
local ffmpeg_start_recording = function(audio, filename)
	...
	ffmpeg_pid = awful.spawn.easy_async_with_shell(
		...
		-i :0.0+]] .. scripts_tbl.user_offset .. ' ' .. add_audio_str .. [[ -r 30 -c:v h264 -crf 0 -preset ultrafast -c:a aac $file_name
		]], 
