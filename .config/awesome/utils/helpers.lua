...
local prompt_font = "Fira Code Mono 5"
function helpers.prompt(action, textbox, prompt, callback)
    ...
    if action == "run" then
        awful.prompt.run {
            ...
            textbox      = textbox,
            font = prompt_font,
            --bg_cursor = "linear:0,0:200,0:0,#1daed4:0,#6f86c9:1,#e379d8",
            fg_cursor = "#000000",
            --ul_cursor = "double",
    ...
    elseif action == "web_search" then
        awful.prompt.run {
            ...
            textbox      = textbox,
            font = prompt_font,
            --bg_cursor =  "linear:0,0:200,0:0,#1daed4:0.5,#6f86c9:1,#e379d8",
            bg_cursor =  "#ffffff00",
            --fg_cursor =  "linear:0,0:200,0:0,#1daed4:0.5,#6f86c9:1,#e379d8",
            --bg_cursor =  {type = "linear", from = {0,0}, to = {0, 200}, stops = {{0, "#1daed4"},{0.5, "#6f86c9"},{1, "#e379d8"}}},
